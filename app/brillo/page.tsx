...
// Rímel / Máscara de Pestañas como protagonista
const PRODUCTS = [
  { id: 'r1', name: 'Rímel Voluminizador', family: 'Máscara de Pestañas', category: 'A prueba de agua', price: 120, colorHex: '#212121', imageUrl: 'https://images.unsplash.com/photo-1512496015851-a1c8d4f051c0?w=400&q=80' },
  { id: 'r2', name: 'Rímel Alargador', family: 'Máscara de Pestañas', category: 'A prueba de agua', price: 120, colorHex: '#000000', imageUrl: 'https://images.unsplash.com/photo-1512496015851-a1c8d4f051c0?w=400&q=80' },
  { id: 'r3', name: 'Rímel Rizador', family: 'Máscara de Pestañas', category: 'Efecto curvador', price: 120, colorHex: '#1a237e', imageUrl: 'https://images.unsplash.com/photo-1512496015851-a1c8d4f051c0?w=400&q=80' },
];

const FAMILIES = ['Máscara de Pestañas'];
  ...
  return (
    <main className={styles.main}>
      <header className={styles.hero} style={{ paddingBottom: '1rem' }}>
        <h1 className={styles.heroTitle}>Rímel & Máscara</h1>
        <p className={styles.heroSubtitle}>
          Pestañas largas, voluminosas y definidas. La mirada que siempre quisiste.
        </p>
      ...
      <section
        ...
        style={{
          ...
          maxWidth: '100vw',
          overflow: 'hidden',
          // Degradado negro humo elegante, ideal para rímel
          background: 'linear-gradient(90deg, #b0bec5 0%, #ffffff 40%, #ffffff 60%, #b0bec5 100%)'
        }}
      >
        {viewMode === 'coverflow' ? (
