...
const ALL_PRODUCTS = [
  ...
  { id: 'r3',  name: 'Rojo Quemado',  href: '/labiales', colorHex: '#b71c1c', imageUrl: '/Rojo Quemado.jpg' },
  ...
  { id: 'r8',  name: 'Naranja Mate',  href: '/labiales', colorHex: '#e64a19', imageUrl: '/Naranja Mate.jpg' },
  { id: 'r9',  name: 'Tangerin',      href: '/labiales', colorHex: '#ff6d00', imageUrl: '/Tangerin.jpg' },
  { id: 'r10', name: 'Mamey',         href: '/labiales', colorHex: '#d84315', imageUrl: '/Mamey .jpg' },
  { id: 'r11', name: 'Oro Sol',       href: '/labiales', colorHex: '#ffd54f', imageUrl: '/Oro Sol.jpg' },
  // ── ROSAS & FUCSIAS ──
  { id: 'p1',  name: 'Fiusha',        href: '/labiales', colorHex: '#e91e8c', imageUrl: '/Fiusha.jpg' },
  { id: 'p2',  name: 'Fiusha Mate',   href: '/labiales', colorHex: '#c2185b', imageUrl: '/Fiusha mate.jpg' },
  { id: 'p3',  name: 'Rosa Neon',     href: '/labiales', colorHex: '#f50057', imageUrl: '/Rosa Neon.jpg' },
  { id: 'p4',  name: 'Rosa Mx',       href: '/labiales', colorHex: '#ec407a', imageUrl: '/Rosa Mx.jpg' },
  { id: 'p5',  name: 'Rose',          href: '/labiales', colorHex: '#f06292', imageUrl: '/Rose.jpg' },
  { id: 'p6',  name: 'Rosa Seda',     href: '/labiales', colorHex: '#f48fb1', imageUrl: '/Rosa Seda.jpg' },
  { id: 'p7',  name: 'Palo Rosa',     href: '/labiales', colorHex: '#f8bbd0', imageUrl: '/Palo Rosa.jpg' },
  { id: 'p8',  name: 'Bugambilia',    href: '/labiales', colorHex: '#ad1457', imageUrl: '/Bugambilia.jpg' },
  { id: 'p9',  name: 'Anis',          href: '/labiales', colorHex: '#d81b60', imageUrl: '/Anis .jpg' },
  ...
  { id: 'v10', name: 'Blackberry',    href: '/labiales', colorHex: '#4a148c', imageUrl: '/Blackberry .jpg' },
  ...
  { id: 's1', name: 'Sombra Clara',  href: '/sombras',      colorHex: '#d7ccc8', imageUrl: 'https://images.unsplash.com/photo-1596704017254-9b121068fb31?w=400&q=80' },
  { id: 's2', name: 'Sombra Media',  href: '/sombras',      colorHex: '#8d6e63', imageUrl: 'https://images.unsplash.com/photo-1596704017254-9b121068fb31?w=400&q=80' },
  { id: 's3', name: 'Sombra Oscura', href: '/sombras',      colorHex: '#4e342e', imageUrl: 'https://images.unsplash.com/photo-1596704017254-9b121068fb31?w=400&q=80' },
  { id: 's4', name: 'Sombra Negra',  href: '/sombras',      colorHex: '#212121', imageUrl: 'https://images.unsplash.com/photo-1596704017254-9b121068fb31?w=400&q=80' },
...
export default function ProductStoriesBar() {
  ...
  const handleClick = (index: number) => {
    if (index === activeIndex) {
      // Si ya está seleccionado, navegar a la tienda
      router.push(ALL_PRODUCTS[index].href);
    } else {
          ...
          return (
            <div
              ...
              style={{
                ...
                // Borde de color del producto, igual que en el Coverflow de la tienda
                border: isCenter
